...
public class NotesAdapter extends RecyclerView.Adapter<ru.geekbrains.lesson6_notepad.NotesAdapter.ViewHolder> {
    private Note[] notes;
    ...
    @NonNull
    @Override
    public ru.geekbrains.lesson6_notepad.NotesAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ru.geekbrains.lesson6_notepad.NotesAdapter.ViewHolder holder, int position) {
