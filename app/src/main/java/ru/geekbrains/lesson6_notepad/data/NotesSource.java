...
public class NotesSource implements NotesSourceInterface, Parcelable {
    ...
    public NotesSourceInterface init(NotesSourceResponse notesSourceResponse) {
        Note[] notesArray = new Note[]{
                ...
                new Note(resources.getString(R.string.tenth_note_title), resources.getString(R.string.tenth_note_content), getDateOfCreation()),
                new Note(resources.getString(R.string.eleventh_note_title), resources.getString(R.string.eleventh_note_content), getDateOfCreation()),
